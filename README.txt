...
a persistence unit "educafacilPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "educafacil/pom.xml":
...
artifacts ("educafacil-ejb.jar" and "educafacil-web.war") are already built. You can build
